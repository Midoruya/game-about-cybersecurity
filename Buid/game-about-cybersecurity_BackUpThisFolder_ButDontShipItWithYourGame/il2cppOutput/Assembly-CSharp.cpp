...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Main_Start_m3F24386331750B440050C96242A7E4040149232D (Main_tDB418C89D33CD2699713F36E95C4373C8892C046 * __this, const RuntimeMethod* method)
{
	...
	String_t* G_B2_0 = NULL;
	{
		...
		int32_t L_13;
		L_13 = Random_Range_m4B3A0037ACA057F33C94508F908546B9317D996A(3, 8, /*hidden argument*/NULL);
		V_0 = L_13;
...
IL_001f:
	...
	}
	{
		...
		V_1 = 0;
		// foreach (var block in ip_block_list)
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_4 = __this->get_ip_block_list_16();
		NullCheck(L_4);
...
IL_0041:
		{
			// foreach (var block in ip_block_list)
			String_t* L_6;
			L_6 = Enumerator_get_Current_m9B0E356FA9FCFB9B1BECC6D7C5DF5C03309251AA_inline((Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B *)(&V_2), /*hidden argument*/Enumerator_get_Current_m9B0E356FA9FCFB9B1BECC6D7C5DF5C03309251AA_RuntimeMethod_var);
			// string[] block_ip = block.Split(':');
			...
			Dictionary_2_tDE3227CA5E7A32F5070BD24C69F42204A3ADE9D5 * L_10 = __this->get_untrusted_connect_12();
			...
			NullCheck(L_10);
			bool L_14;
			L_14 = Dictionary_2_TryGetValue_m4519CCC2D78183181E5B916CE527868718A804FD(L_10, L_13, (String_t**)(&V_4), /*hidden argument*/Dictionary_2_TryGetValue_m4519CCC2D78183181E5B916CE527868718A804FD_RuntimeMethod_var);
			if (!L_14)
			{
				goto IL_0071;
			}
...
IL_0075:
		{
			// foreach (var block in ip_block_list)
			bool L_17;
			L_17 = Enumerator_MoveNext_mCE70417061695048D84E473D50556E46B8630F54((Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B *)(&V_2), /*hidden argument*/Enumerator_MoveNext_mCE70417061695048D84E473D50556E46B8630F54_RuntimeMethod_var);
			if (L_17)
			{
				goto IL_0041;
			}
...
IL_008e:
	{
		...
		Finish_t05AFABC437BAC217278BEDDF07674FDDBB465F2E * L_18 = __this->get_end_level_11();
		Dictionary_2_tDE3227CA5E7A32F5070BD24C69F42204A3ADE9D5 * L_19 = __this->get_untrusted_connect_12();
		NullCheck(L_19);
		int32_t L_20;
		L_20 = Dictionary_2_get_Count_m0D12A8E922828B1FBE6FCA8D404FDA65E0F78CDA(L_19, /*hidden argument*/Dictionary_2_get_Count_m0D12A8E922828B1FBE6FCA8D404FDA65E0F78CDA_RuntimeMethod_var);
		int32_t L_21;
		L_21 = Random_Range_m4B3A0037ACA057F33C94508F908546B9317D996A(5, ((int32_t)15), /*hidden argument*/NULL);
		int32_t L_22 = V_0;
		int32_t L_23 = V_1;
		NullCheck(L_18);
		L_18->set_quality_of_execution_4(((int32_t)il2cpp_codegen_subtract((int32_t)((int32_t)il2cpp_codegen_multiply((int32_t)((int32_t)((int32_t)((int32_t)100)/(int32_t)((int32_t)il2cpp_codegen_add((int32_t)L_20, (int32_t)L_21)))), (int32_t)L_22)), (int32_t)((int32_t)il2cpp_codegen_multiply((int32_t)L_23, (int32_t)3)))));
		// end_level.this_canvas.gameObject.SetActive(true);
		Finish_t05AFABC437BAC217278BEDDF07674FDDBB465F2E * L_24 = __this->get_end_level_11();
		NullCheck(L_24);
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_25 = L_24->get_this_canvas_5();
		NullCheck(L_25);
		...
		Finish_t05AFABC437BAC217278BEDDF07674FDDBB465F2E * L_27 = __this->get_end_level_11();
		NullCheck(L_27);
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_28 = L_27->get_this_canvas_5();
		NullCheck(L_28);
		Behaviour_set_enabled_mDE415591B28853D1CD764C53CB499A2142247F32(L_28, (bool)1, /*hidden argument*/NULL);
		// this_canvas.gameObject.SetActive(false);
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_29 = __this->get_this_canvas_4();
		NullCheck(L_29);
		...
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_31 = __this->get_this_canvas_4();
		NullCheck(L_31);
...
IL_00fa:
	{
		...
		Text_t6A2339DA6C05AE2646FC1A6C8FCC127391BE7FA1 * L_32 = __this->get_terminal_timer_7();
		float L_33 = __this->get_time_to_complete_minute_5();
		int32_t L_34 = il2cpp_codegen_cast_double_to_int<int32_t>(((float)((float)L_33/(float)(60.0f))));
		RuntimeObject * L_35 = Box(Int32_tFDE5F8CD43D10453F6A2E0C77FE48C6CC7009046_il2cpp_TypeInfo_var, &L_34);
		String_t* L_36;
		L_36 = String_Format_mB3D38E5238C3164DB4D7D29339D9E225A4496D17(_stringLiteralFEBFE8DC5CF0DCBA1A326E84C06258E548D1BFB2, L_35, /*hidden argument*/NULL);
		NullCheck(L_32);
		...
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_37 = __this->get_outnput_console_list_15();
		NullCheck(L_37);
		int32_t L_38;
	...
	}
	{
		...
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_39 = __this->get_outnput_console_list_15();
		NullCheck(L_39);
		int32_t L_40;
		L_40 = List_1_get_Count_m199DB87BCE947106FBA38E19FDFE80CB65B61144_inline(L_39, /*hidden argument*/List_1_get_Count_m199DB87BCE947106FBA38E19FDFE80CB65B61144_RuntimeMethod_var);
		V_5 = ((int32_t)il2cpp_codegen_subtract((int32_t)L_40, (int32_t)((int32_t)17)));
...
IL_0145:
	{
		...
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_41 = __this->get_outnput_console_list_15();
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_42 = __this->get_outnput_console_list_15();
		NullCheck(L_42);
		String_t* L_43;
		L_43 = List_1_get_Item_m8578F26F0FE72EDB6A0290D78944B3D4F34DBFAC_inline(L_42, 0, /*hidden argument*/List_1_get_Item_m8578F26F0FE72EDB6A0290D78944B3D4F34DBFAC_RuntimeMethod_var);
		NullCheck(L_41);
		bool L_44;
		L_44 = List_1_Remove_m31C26124B7BB19A0E5C12113701DDE5046272F70(L_41, L_43, /*hidden argument*/List_1_Remove_m31C26124B7BB19A0E5C12113701DDE5046272F70_RuntimeMethod_var);
		// for (int i = 0; i < delete_item; i++)
		int32_t L_45 = V_6;
...
IL_0169:
	{
		// if (ip_block_list.Count >= untrusted_connect.Count)
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_48 = __this->get_ip_block_list_16();
		NullCheck(L_48);
		int32_t L_49;
		...
		Dictionary_2_tDE3227CA5E7A32F5070BD24C69F42204A3ADE9D5 * L_50 = __this->get_untrusted_connect_12();
		NullCheck(L_50);
		int32_t L_51;
		L_51 = Dictionary_2_get_Count_m0D12A8E922828B1FBE6FCA8D404FDA65E0F78CDA(L_50, /*hidden argument*/Dictionary_2_get_Count_m0D12A8E922828B1FBE6FCA8D404FDA65E0F78CDA_RuntimeMethod_var);
	...
	}
	{
		...
		V_7 = 0;
		// foreach (var block in ip_block_list)
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_52 = __this->get_ip_block_list_16();
		NullCheck(L_52);
		Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B  L_53;
		L_53 = List_1_GetEnumerator_m35388695226DE2F7B0B5D0A07016716D6AD9CAEF(L_52, /*hidden argument*/List_1_GetEnumerator_m35388695226DE2F7B0B5D0A07016716D6AD9CAEF_RuntimeMethod_var);
		V_2 = L_53;
	}
...
IL_0195:
		{
			// foreach (var block in ip_block_list)
			String_t* L_54;
			L_54 = Enumerator_get_Current_m9B0E356FA9FCFB9B1BECC6D7C5DF5C03309251AA_inline((Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B *)(&V_2), /*hidden argument*/Enumerator_get_Current_m9B0E356FA9FCFB9B1BECC6D7C5DF5C03309251AA_RuntimeMethod_var);
			// string[] block_ip = block.Split(':');
			...
			NullCheck(L_56);
			(L_56)->SetAt(static_cast<il2cpp_array_size_t>(0), (Il2CppChar)((int32_t)58));
			NullCheck(L_54);
			...
			V_8 = L_57;
			// if (untrusted_connect.TryGetValue(block_ip[0], out _))
			Dictionary_2_tDE3227CA5E7A32F5070BD24C69F42204A3ADE9D5 * L_58 = __this->get_untrusted_connect_12();
			StringU5BU5D_tACEBFEDE350025B554CD507C9AE8FFE49359549A* L_59 = V_8;
			NullCheck(L_59);
			int32_t L_60 = 0;
			String_t* L_61 = (L_59)->GetAt(static_cast<il2cpp_array_size_t>(L_60));
			NullCheck(L_58);
			bool L_62;
			L_62 = Dictionary_2_TryGetValue_m4519CCC2D78183181E5B916CE527868718A804FD(L_58, L_61, (String_t**)(&V_4), /*hidden argument*/Dictionary_2_TryGetValue_m4519CCC2D78183181E5B916CE527868718A804FD_RuntimeMethod_var);
			if (!L_62)
			{
				goto IL_01c7;
			}
...
IL_01c7:
		{
			// foreach (var block in ip_block_list)
			bool L_64;
			L_64 = Enumerator_MoveNext_mCE70417061695048D84E473D50556E46B8630F54((Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B *)(&V_2), /*hidden argument*/Enumerator_MoveNext_mCE70417061695048D84E473D50556E46B8630F54_RuntimeMethod_var);
			if (L_64)
			{
				goto IL_0195;
			}
...
IL_01e0:
	{
		...
		int32_t L_65 = V_7;
		Dictionary_2_tDE3227CA5E7A32F5070BD24C69F42204A3ADE9D5 * L_66 = __this->get_untrusted_connect_12();
		NullCheck(L_66);
		int32_t L_67;
		L_67 = Dictionary_2_get_Count_m0D12A8E922828B1FBE6FCA8D404FDA65E0F78CDA(L_66, /*hidden argument*/Dictionary_2_get_Count_m0D12A8E922828B1FBE6FCA8D404FDA65E0F78CDA_RuntimeMethod_var);
	...
	}
	{
		...
		// end_level.this_canvas.gameObject.SetActive(true);
		Finish_t05AFABC437BAC217278BEDDF07674FDDBB465F2E * L_68 = __this->get_end_level_11();
		NullCheck(L_68);
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_69 = L_68->get_this_canvas_5();
		NullCheck(L_69);
		...
		// end_level.this_canvas.enabled = true;
		Finish_t05AFABC437BAC217278BEDDF07674FDDBB465F2E * L_71 = __this->get_end_level_11();
		NullCheck(L_71);
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_72 = L_71->get_this_canvas_5();
		NullCheck(L_72);
		Behaviour_set_enabled_mDE415591B28853D1CD764C53CB499A2142247F32(L_72, (bool)1, /*hidden argument*/NULL);
		// this_canvas.gameObject.SetActive(false);
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_73 = __this->get_this_canvas_4();
		NullCheck(L_73);
		...
		NullCheck(L_74);
		GameObject_SetActive_mCF1EEF2A314F3AE85DA581FF52EB06ACEF2FFF86(L_74, (bool)0, /*hidden argument*/NULL);
		// this_canvas.enabled = false;
		Canvas_t2B7E56B7BDC287962E092755372E214ACB6393EA * L_75 = __this->get_this_canvas_4();
		NullCheck(L_75);
...
IL_0239:
	{
		// terminal_panel.text = "";
		Text_t6A2339DA6C05AE2646FC1A6C8FCC127391BE7FA1 * L_76 = __this->get_terminal_panel_6();
		NullCheck(L_76);
		VirtActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_76, _stringLiteralDA39A3EE5E6B4B0D3255BFEF95601890AFD80709);
		// foreach (var command in outnput_console_list)
		List_1_t6C9F81EDBF0F4A31A9B0DA372D2EF34BDA3A1AF3 * L_77 = __this->get_outnput_console_list_15();
		NullCheck(L_77);
		Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B  L_78;
		L_78 = List_1_GetEnumerator_m35388695226DE2F7B0B5D0A07016716D6AD9CAEF(L_77, /*hidden argument*/List_1_GetEnumerator_m35388695226DE2F7B0B5D0A07016716D6AD9CAEF_RuntimeMethod_var);
		V_2 = L_78;
	}
...
IL_0257:
		{
			// foreach (var command in outnput_console_list)
			String_t* L_79;
			L_79 = Enumerator_get_Current_m9B0E356FA9FCFB9B1BECC6D7C5DF5C03309251AA_inline((Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B *)(&V_2), /*hidden argument*/Enumerator_get_Current_m9B0E356FA9FCFB9B1BECC6D7C5DF5C03309251AA_RuntimeMethod_var);
			V_9 = L_79;
			// terminal_panel.text += command;
			Text_t6A2339DA6C05AE2646FC1A6C8FCC127391BE7FA1 * L_80 = __this->get_terminal_panel_6();
			Text_t6A2339DA6C05AE2646FC1A6C8FCC127391BE7FA1 * L_81 = L_80;
			NullCheck(L_81);
			String_t* L_82;
			L_82 = VirtFuncInvoker0< String_t* >::Invoke(74 /* System.String UnityEngine.UI.Text::get_text() */, L_81);
			String_t* L_83 = V_9;
			String_t* L_84;
			L_84 = String_Concat_m4B4AB72618348C5DFBFBA8DED84B9E2EBDB55E1B(L_82, L_83, /*hidden argument*/NULL);
			NullCheck(L_81);
			VirtActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_81, L_84);
		}
...
IL_0278:
		{
			// foreach (var command in outnput_console_list)
			bool L_85;
			L_85 = Enumerator_MoveNext_mCE70417061695048D84E473D50556E46B8630F54((Enumerator_tCDCE241581BD00D8EDB03C9DC4133A65ADABF67B *)(&V_2), /*hidden argument*/Enumerator_MoveNext_mCE70417061695048D84E473D50556E46B8630F54_RuntimeMethod_var);
			if (L_85)
			{
				goto IL_0257;
			}
...
IL_0281:
		{
			IL2CPP_LEAVE(0x291, FINALLY_0283);
		}
	} // end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
